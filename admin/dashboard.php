            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="ibox bg-info color-white widget-stat">
                        <div class="ibox-body">
                            <h2 class="m-b-5 font-strong">
                                <?php
                                echo number_format($total_order_amount, 0, ',', '.') . ' VND';
                                ?>
                            </h2>
                            <div class="m-b-5">Doanh thu</div><i class="ti-bar-chart widget-stat-icon"></i>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="ibox bg-warning color-white widget-stat">
                        <div class="ibox-body">
                            <h2 class="m-b-5 font-strong">
                            <?php echo $total_orders_with_status_1; ?>

                            </h2>
                            <div class="m-b-5">Số đơn chưa xử lí</div>
                ...
                <!-- <div class="col-lg-3 col-md-6">
                    <div class="ibox bg-danger color-white widget-stat">
                        <div class="ibox-body">
                            ...
                            <div class="m-b-5">Doanh thu</div><i class="ti-user widget-stat-icon"></i>
